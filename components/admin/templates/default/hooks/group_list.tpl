...
<div class="portlet">
	...
	<div class="portlet-body">
		<p>	
			<a href="{$aTemplate.host}admin/{$sAction}/groupadd/" class="btn green"><i class="icon-plus"></i> Добавить группу хуков</a>
			<a href="#" class="btn" data-set="/admin/{$sAction}/groupdeleteall/" id="deleteChosen"><i class="icon-trash"></i> Удалить выбранные</a>
			<a href="{$aTemplate.host}admin/{$sAction}/" class="btn"><i class="icon-th-list"></i> Хуки</a>
		</p>
						...
						<td>
							<div class="btn-group no-margin">
								...
								<ul class="dropdown-menu nodes-dropdown">
									<li><a href="{$aTemplate.host}admin/{$sAction}/groupedit/{$oGroup->getId()}/"><i class="icon-pencil"></i> Редактировать</a></li>
									<li><a href="#modalDelete" data-toggle="modal" onclick="modalConfirmDeleteGroup({$oGroup->getId()});"><i class="icon-trash"></i> Удалить</a></li>
								</ul>
							</div>
						</td>
						<td>
							<a href="{$aTemplate.host}admin/{$sAction}/groupedit/{$oGroup->getId()}/">
								{$oGroup->getName()}
							</a>
						</td>
