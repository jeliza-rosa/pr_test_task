	               ...
	               <div class="tab-content">
	                     ...
	                     <div class="tab-pane active" id="portlet_tab1">
			               ...
			               <div class="control-group">
			                  ...
			                  <div class="controls">
			                     <input name="date" value="{$aRequest.date}" type="date" class="span-auto m-wrap">
			                     <input name="time" value="{$aRequest.time}" type="time" class="span-auto m-wrap">
			                  </div>
			               </div>
			               <div class="control-group">
			                  <label class="control-label">Анонс новости</label>
			                  <div class="controls">
				                  <textarea class="span6 m-wrap popovers" name="announcement" rows="4" data-trigger="hover" data-original-title="Анонс новости" data-content="Краткое описание новости. Одно-два предложения.">{$aRequest.announcement}</textarea>
			                  </div>
	                  	  </div>
	                  	  <div class="control-group">
			                  <label class="control-label">Текст новости</label>
			                  <div class="controls">
				                  <textarea class="span12 ckeditor m-wrap" name="body" rows="6">{$aRequest.body}</textarea>
			                  </div>
	                  	  </div>
			              <div class="control-group">
